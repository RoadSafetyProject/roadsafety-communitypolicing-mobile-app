package wappi.iRoadCommunityPolicing.Dhis2;
...
public class DHIS2Modal {
    ...
    public Program getProgramByName(String name){
        name = name.replace("_"," ");
        for(int i = 0;i < MainActivity.programs.size();i++){
            if(MainActivity.programs.get(i).getName().equals(name)){
                return MainActivity.programs.get(i);
            }
        }
        return null;
    }
    ...
    public DataElements getDataElement(String id) {
        for (int i = 0; i < MainActivity.dataElements.size(); i++) {
            if (MainActivity.dataElements.get(i).getId().equals(id)) {
                return MainActivity.dataElements.get(i);
            }
        }
        return null;
    }
    ...
    public DataElements getDataElementByName(String name) {
        for (int i = 0; i < MainActivity.dataElements.size(); i++) {
            if (MainActivity.dataElements.get(i).getName().equals(name)) {
                return MainActivity.dataElements.get(i);
            }
        }
        return null;
