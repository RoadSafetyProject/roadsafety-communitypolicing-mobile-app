...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		textAllCaps = true;//a.getBoolean(R.styleable.PagerSlidingTabStrip_textAllCaps, textAllCaps);
		...
		defaultTabLayoutParams = new LinearLayout.LayoutParams(metrics.widthPixels/2, LayoutParams.MATCH_PARENT);
